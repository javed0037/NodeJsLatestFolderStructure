...
let childLevelMetaData = () => {

  let list_of_child_by_lavel = [];
  list_of_child_by_lavel.push({
    "level": 1,
    "list_of_child": []
  })
  list_of_child_by_lavel.push({
  ...
  return list_of_child_by_lavel;
}
let parentLevelMetaData = () => {


  let list_of_parent_by_level = [];
  list_of_parent_by_level.push({
    "level": 1,
    "parent_id": null
  })
  list_of_parent_by_level.push({
  ...
  return list_of_parent_by_level;
}
let paymentMetaData = () => {
  let payment = [];
  payment.push({
  ...
  payment.push({
    ...
    "pay_id": 10002,
    "logo": "https://upload.wikimedia.org/wikipedia/commons/b/b1/PhonePe.png",
    "linked_number": null,
    "upi_id": null
  })
  payment.push({
    "is_saved": false,
    "payment_type": "Google Tez",
    "pay_id": 10003,
    "logo": "https://upload.wikimedia.org/wikipedia/commons/0/03/GPay_%28or_Google_Pay%2C_Pay_with_Google%29_Brand_Mark.png",
    "linked_number": null,
    "upi_id": null
  })
  return payment;
...
module.exports = {
  ...
  childLevelMetaData: childLevelMetaData,
  parentLevelMetaData: parentLevelMetaData,
